    ...
    function(Backbone, $, _, Main, tweenlite, tweenmax, modernizr, bowser, glitch, Helpers) {
        var DesktopView = Backbone.View.extend({
            ...
            _cycleLogo: function () {
                ...
                to($('.logo #background image'), 1, { attr:{ y: '-600' } }, 0).
                to($('.logo #background image'), 2, { attr:{ y: '-900' } }, 0).
                to($('.logo #background image'), 3, { attr:{ y: '-1200' } }, 0).
                to($('.logo #background image'), 4, { attr:{ y: '-1500' } }, 0);
