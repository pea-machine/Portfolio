    ...
    function(Backbone, $, _, Main, tweenlite, tweenmax, modernizr, bowser, glitch, Helpers) {
        var DesktopView = Backbone.View.extend({
            ...
            _cycleLogo: function () {
                ...
                tl.timeScale(10).
                to($('.logo #background image'), 1, { attr:{ y: '-300' } }, 0).
                to($('.logo #background image'), 1, { attr:{ y: '-600' } }, 1).
                to($('.logo #background image'), 1, { attr:{ y: '-900' } }, 2).
                to($('.logo #background image'), 1, { attr:{ y: '-1200' } }, 3).
                to($('.logo #background image'), 1, { attr:{ y: '-1500' } }, 4);
